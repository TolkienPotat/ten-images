...
public class Particle {
	...
	public void render(Renderer r, Camera c) {
		...
		r.begin();
		t.bind();
		r.drawRotatedTexture(x, y, x + particleSize, y + particleSize, drawX, drawY, drawX2, drawY2, color, inGameX, inGameY, jungle, rotation);
		r.end();
	}
	...
	public int tick() {
		...
		if (deltaRotation > 0) deltaRotation--;
		if (deltaRotation < 0) deltaRotation++;
